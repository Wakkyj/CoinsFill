  ...
  return (
    <main >
      ...
      <div className="flex items-center justify-center flex-wrap flex-col pt-[47px]">
        <div className='bg-gradient-to-b from-[#4936D4] to-[#6835D4] rounded-[35px] opacity-80 w-[375px] h-[594px] absolute z-0'></div>
        <form className="w-[375px] h-[655px] text-white flex flex-wrap table-column text-center z-2 opacity-90">
